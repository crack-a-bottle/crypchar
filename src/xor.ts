...
function xor(data: string | ArrayBuffer | NodeJS.ArrayBufferView, key: number, encoding: string): string;
function xor(data: string | ArrayBuffer | NodeJS.ArrayBufferView, key: number): Uint8Array;
function xor(data: string | ArrayBuffer | NodeJS.ArrayBufferView, key: number, encoding?: string): string | Uint8Array {
