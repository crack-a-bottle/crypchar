...
function nand(data: string | ArrayBuffer | NodeJS.ArrayBufferView, key: number, encoding: BufferEncoding): string;
function nand(data: string | ArrayBuffer | NodeJS.ArrayBufferView, key: number): Buffer;
function nand(data: string | ArrayBuffer | NodeJS.ArrayBufferView, key: number, encoding?: BufferEncoding): string | Buffer {
    const k = Number(key);
