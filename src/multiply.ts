...
function multiply(data: string | ArrayBuffer | NodeJS.ArrayBufferView, key: number, encoding: BufferEncoding): string;
function multiply(data: string | ArrayBuffer | NodeJS.ArrayBufferView, key: number): Buffer;
function multiply(data: string | ArrayBuffer | NodeJS.ArrayBufferView, key: number, encoding?: BufferEncoding): string | Buffer {
    const k = Number(key);
