...
function xnor(data: string | ArrayBuffer | NodeJS.ArrayBufferView, key: number, encoding: BufferEncoding): string;
function xnor(data: string | ArrayBuffer | NodeJS.ArrayBufferView, key: number): Buffer;
function xnor(data: string | ArrayBuffer | NodeJS.ArrayBufferView, key: number, encoding?: BufferEncoding): string | Buffer {
    const k = Number(key);
